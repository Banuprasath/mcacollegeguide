    ...
    <div class="container my-5">
        <div class="bg-white rounded shadow-sm p-4">
                    ...
                    <<select name='clgname' id="collegeSelect" class="form-select">
                        ...
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<option value='{$row['c-code']}' id='clg' >{$row['c-name']}</option>";
                            }
                        }
                        ?>
                        </select>
            ...
            if (isset($_POST['submit'])) {
                ...
                echo '<script>$("#clg").value("hello");</script>';
                //  echo "<p class='text-primary mb-4'>College Code: <strong>$choosen_college</strong></p>";
